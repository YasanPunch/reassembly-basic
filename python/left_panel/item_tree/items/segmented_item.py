...
class SegmentedItem(BaseItem):
    ...
    def __init__(
        self,
        label: str,
        segment_faces: np.ndarray = None,
        segment_mesh: o3d.geometry.TriangleMesh = None,
        original_mesh=None,
        preprocessed_item=None,
        segment_properties: Dict[str, Any] = None,
        segment_color: List[float] = None,
        scene_path: str = "",
        ...
        Args:
            ...
            scene_path (str): Path/name for this segment in the 3D scene
